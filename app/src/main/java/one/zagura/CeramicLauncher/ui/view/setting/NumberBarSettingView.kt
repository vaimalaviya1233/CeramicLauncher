...
import one.zagura.CeramicLauncher.ui.view.FontFitTextView
import one.zagura.CeramicLauncher.ui.view.Seekbar
...
class NumberBarSettingView : IntSettingView {
    ...
    constructor(c: Context, key: String, default: Int, labelId: Int, startsWith1: Boolean, max: Int) : super(c, key, default, labelId, 0, 0) {
