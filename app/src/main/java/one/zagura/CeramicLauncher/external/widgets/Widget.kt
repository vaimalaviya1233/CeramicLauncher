package one.zagura.CeramicLauncher.external.widgets
                        ...
                        adapter = object : RecyclerView.Adapter<VH>() {
                            ...
                            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
                                val label = TextView(context).apply {
                                    setTextColor(context.resources.getColor(R.color.ui_card_text))
                                    textSize = 12f
                                ...
                                val v = CardView(context).apply {
                                    ...
                                    setCardBackgroundColor(resources.getColor(R.color.ui_card_background))
                                    cardElevation = 10f
